    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start animate-fade-in-up delay-100">
        ...
        <div class="flex flex-col space-y-8">
            ...
            <div class="flex flex-row gap-4 border-t border-white/10 pt-8 mt-auto">
                <a href="{{ route('cart.add', $product->id) }}" class="w-[80%] bg-brand-neon hover:bg-white text-black font-display font-bold py-4 rounded-xl shadow-[0_0_20px_rgba(57,255,20,0.3)] hover:shadow-[0_0_30px_rgba(255,255,255,0.5)] transition-all transform hover:-translate-y-1 flex items-center justify-center gap-3">
